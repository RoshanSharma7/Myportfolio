...
// const MODELS = [
//   { url: '/models/laptop.glb',  size: 4 },
//   { url: '/models/cricket.glb', size: 6 },
//   { url: '/models/Box_01.glb',  size: 5 },
// ]
...
//     // Reset rotation counter for each new model
//     rotated.current = 0
//   }, [scene, size])
...
//     // After full 360° call onComplete
...
//     }}>
//       <Canvas
//         camera={{ position: [0, 1, 10], fov:  isMobile ? 65 : 50 }}
//         style={{ background: 'transparent' }}
//       >
//         <ambientLight intensity={5} />
//         <spotLight position={[10, 10, 10]} intensity={4} castShadow />
//         <spotLight position={[-10, 8, 5]}  intensity={3} />
...
//           <SingleModel
//             key={MODELS[index].url}
//             url={MODELS[index].url}
//             size={MODELS[index].size}
...
const MODELS = [
  ...
  { url: '/models/cricket.glb', desktopSize: 6.5, mobileSize: 7 },
  { url: '/models/Box_01.glb',  desktopSize: 4, mobileSize: 5.5 },
]
