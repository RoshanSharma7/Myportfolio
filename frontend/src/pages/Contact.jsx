...
function ContactInfoSkeleton() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <div className="card">
        <SkeletonBox width="120px" height="0.9rem" style={{ marginBottom: '1rem' }} />
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
      ...
      <div className="card">
        <SkeletonBox width="90px" height="0.9rem" style={{ marginBottom: '1rem' }} />
    ...
    <div style={{
      ...
      <div className="section">
        ...
        <div style={{
          ...
          <ContactForm />
          {loading ? <ContactInfoSkeleton /> : <ContactInfo profile={profile} links={links} />}
        </div>
